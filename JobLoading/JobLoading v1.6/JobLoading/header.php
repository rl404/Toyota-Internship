<?php
	...
	if($_SESSION['deptname'] == "EA" || $_SESSION['titlerank'] >= 3){
		echo "<div class='ui simple dropdown item'>
			...
			<div class='menu'>
				...
				<a href='http://".$_SERVER['HTTP_HOST']."/JobLoading/input/job.php' class='item'>New Job</a>";
				if($_SESSION['deptname'] == "EA"){
		echo "		<a href='http://".$_SERVER['HTTP_HOST']."/JobLoading/input/project.php' class='item'>New Project</a>
