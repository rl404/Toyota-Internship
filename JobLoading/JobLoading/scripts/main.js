...
$(document).ready(function() {
   ...
   // update/update.php
   $("#inputhourtable").on("change","#jobweek", function(){
     event.preventDefault();  // Do not run the default action
   ...
   $("#inputhourtable").on("change","#jobmonth", function(){
     event.preventDefault();  // Do not run the default action
      var submittedweek = document.getElementById("jobweek").value;
      var submittedmonth = document.getElementById("jobmonth").value;
      var submittedyear = document.getElementById("jobyear").value;
   ...
   var delayTimer;
   $("#inputhourtable").on("keyup","#jobyear", function(){
      event.preventDefault();  // Do not run the default action
      var submittedweek = document.getElementById("jobweek").value;
      var submittedmonth = document.getElementById("jobmonth").value;
      var submittedyear = document.getElementById("jobyear").value;
   ...
   // viewer/viewer.php
   $('#worklisttable').on("change","#jobweek", function () {
      event.preventDefault();  // Do not run the default action
      var submittedweek = document.getElementById("jobweek").value;
      var submittedmonth = document.getElementById("jobmonth").value;
      var submittedyear = document.getElementById("jobyear").value;
   ...
   $('#worklisttable').on("change","#jobmonth", function () {
      event.preventDefault();  // Do not run the default action
      var submittedweek = document.getElementById("jobweek").value;
      var submittedmonth = document.getElementById("jobmonth").value;
      var submittedyear = document.getElementById("jobyear").value;
   ...
   var delayTimer;
   $('#worklisttable').on("keyup","#jobyear", function () {
      event.preventDefault();  // Do not run the default action
      var submittedweek = document.getElementById("jobweek").value;
      var submittedmonth = document.getElementById("jobmonth").value;
      var submittedyear = document.getElementById("jobyear").value;
   ...
   // report/project.php
   $('#homepage').on("input","#projectname", function () {
      event.preventDefault();  // Do not run the default action
   ...
   $('#homepage').on("change","#projectmonth", function () {
      event.preventDefault();  // Do not run the default action
      var submittedproject = document.getElementById("projectname").value;
      var submittedmonth = document.getElementById("projectmonth").value;
      var submittedyear = document.getElementById("projectyear").value;
   ...
   $('#homepage').on("keyup","#projectyear", function () {
      event.preventDefault();  // Do not run the default action
      var submittedproject = document.getElementById("projectname").value;
      var submittedmonth = document.getElementById("projectmonth").value;
      var submittedyear = document.getElementById("projectyear").value;
   ...
   // report/job.php
    $('#homepage').on("input","#jobname", function () {
      event.preventDefault();  // Do not run the default action
    ...
    $('#homepage').on("change","#jobmonth", function () {
      event.preventDefault();  // Do not run the default action
      var submittedjob = document.getElementById("jobname").value;
      var submittedmonth = document.getElementById("jobmonth").value;
      var submittedyear = document.getElementById("jobyear").value;
    ...
    $('#homepage').on("keyup","#jobyear", function () {
      event.preventDefault();  // Do not run the default action
      var submittedjob = document.getElementById("jobname").value;
      var submittedmonth = document.getElementById("jobmonth").value;
      var submittedyear = document.getElementById("jobyear").value;
   ...
   // report/dept.php
   $('#homepage').on("input","#deptname", function () {
      event.preventDefault();  // Do not run the default action
   ...
   $('#homepage').on("change","#deptmonth", function () {
      event.preventDefault();  // Do not run the default action
      var submitteddept = document.getElementById("deptname").value;
      var submittedmonth = document.getElementById("deptmonth").value;
      var submittedyear = document.getElementById("deptyear").value;
   ...
   $('#homepage').on("keyup","#deptyear", function () {
      event.preventDefault();  // Do not run the default action
      var submitteddept = document.getElementById("deptname").value;
      var submittedmonth = document.getElementById("deptmonth").value;
      var submittedyear = document.getElementById("deptyear").value;
   ...
   // report/staff.php
   $('#homepage').on("input","#deptname2", function () {
      event.preventDefault();  // Do not run the default action
   ...
   $('#homepage').on("change","#staffmonth", function () {
      event.preventDefault();  // Do not run the default action
      var submitteddept = document.getElementById("deptname2").value;
      var submittedmonth = document.getElementById("staffmonth").value;
      var submittedyear = document.getElementById("staffyear").value;
   ...
   $('#homepage').on("keyup","#staffyear", function () {
      event.preventDefault();  // Do not run the default action
      var submitteddept = document.getElementById("deptname2").value;
      var submittedmonth = document.getElementById("staffmonth").value;
      var submittedyear = document.getElementById("staffyear").value;
