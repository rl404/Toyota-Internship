...
function editJob(a){
   var submittedjob = document.getElementById("job"+a).value;
   $.ajax({
      type: 'POST',
      url:  'jobedit.php',
      data: { jobid: submittedjob }
   })
      .done( function (responseText) {
         $('#editjobcontent').html(responseText);
      })
...
function deleteJob(a){
   ...
   $.ajax({
      ...
      .done( function (responseText) {
         $('#deletejobcontent').html(responseText);
      })
...
function editProject(a){
   var submittedproject = document.getElementById("project"+a).value;
   $.ajax({
      type: 'POST',
      url:  'projectedit.php',
      data: { projectid: submittedproject }
   })
      .done( function (responseText) {
         $('#editprojectcontent').html(responseText);
      })
...
function deleteProject(a){
   ...
   $.ajax({
      ...
      .done( function (responseText) {
         $('#deleteprojectcontent').html(responseText);
      })

   $(".ui.basic.modal.deletemodal").modal('show');
}

function editStaff(a){
   var submittedstaff = document.getElementById("staff"+a).value;
   $.ajax({
      type: 'POST',
      url:  'staffedit.php',
      data: { staffid: submittedstaff }
   })
      .done( function (responseText) {
         $('#editstaffcontent').html(responseText);
      })
...
function deleteStaff(a){
   ...
   $.ajax({
      ...
      .done( function (responseText) {
         $('#deletestaffcontent').html(responseText);
      })
...
function editDept(a){
   var submitteddept = document.getElementById("dept"+a).value;
   $.ajax({
      type: 'POST',
      url:  'deptedit.php',
      data: { deptid: submitteddept }
   })
      .done( function (responseText) {
         $('#editdeptcontent').html(responseText);
      })
...
function deleteDept(a){
   ...
   $.ajax({
      ...
      .done( function (responseText) {
         $('#deletedeptcontent').html(responseText);
      })
