	...
	if(!notempty($_POST['dept']) || $_POST['dept'] == 'All'){
		...
		echo "<table class='ui selectable sortable center aligned table'>
				<thead><tr>
					...
					<th id='tableheader'>Member</th>
					<th id='tableheader'><div data-tooltip='8 Hours X 20 Days X Total Member'>Ideal Hour</div></th>
		...
		if($selectResult->num_rows > 0){
			...
			for($i = 0; $i < $deptIndex; $i++){
				...
				if($deptHour < (90/100*$staffAvgHour)){
		...
		echo "<table class='ui selectable sortable center aligned table'>
				<thead><tr>
					...
					<th id='tableheader'><div data-tooltip='8 Hours X 20 Days'>Hours (Ideal = 160)</div></th>
				</tr></thead>";
