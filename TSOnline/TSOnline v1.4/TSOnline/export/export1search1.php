<?php
	...
	if($selectResult->num_rows > 0){
		for($i = 0; $i < count($supplier); $i++){
			echo "<tr>
					<td>$no</td>
					<td class='left aligned'><a href='../list/datasupplier.php?search=$supplier[$i]' target='_blank'>PT. $supplier[$i]</a></td>
					<td><button class='ui red inverted tiny button' onclick='showRequest(&quot;$supplier[$i]&quot;);'>Show</button></td>
				</tr>";
			$no++;
		}
	}else{
