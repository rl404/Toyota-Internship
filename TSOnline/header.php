<?php
	...
	<head>
		...
		<link href='http://".$_SERVER['HTTP_HOST']."/TSOnline/css/calendar.css' rel='stylesheet'>
		...
		<script src='http://".$_SERVER['HTTP_HOST']."/TSOnline/scripts/calendar.js'></script>
	</head>
	<body>
	<div class='ui inverted menu' id='superheader'>
		...
		<div class='ui simple dropdown item'>
			...
			<div class='menu'>
				<a href='http://".$_SERVER['HTTP_HOST']."/TSOnline/request/request.php' class='item'>Add New</a>
				<a href='http://".$_SERVER['HTTP_HOST']."/TSOnline/request/deliver.php' class='item'>Deliver</a>
			</div>
		</div>
		<a href='http://".$_SERVER['HTTP_HOST']."/TSOnline/update/partno.php' class='item'>
			Update Part No
		</a>
		<div class='ui simple dropdown item'>
			Update TS Rev.
		...
		<div class='ui simple dropdown item'>
			...
			<div class='menu'>
				...
				<div class='ui left pointing dropdown link item'>
        			...
        			<div class='menu'>
        				<a href='http://".$_SERVER['HTTP_HOST']."/TSOnline/list/contact.php' class='item'>Contact List</a>
        				<a href='http://".$_SERVER['HTTP_HOST']."/TSOnline/update/contact.php' class='item'>Update Contact</a>
					</div>
				</div>	
