	...
	<div class="ui container">
		...
		<div class='ui segment'>
			<h3 class='ui dividing header'>
				V1.9 <span id='titleheader1'>/ 23-Oct-2017</span>
			</h3>			
			<ul class="ui list">
				<li>Changed date input into date picker input.</li>	
				<li>Added send status on TS revision update table on homepage.</li>
				<li>Added delivery status on supplier request table on homepage.</li>
				<li>Added clickable function for summary month on homepage.</li>
				<li>Minor changes</li>			
			</ul>
		</div>
