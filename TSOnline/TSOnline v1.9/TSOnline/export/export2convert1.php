	...
	*/
	...
	for($i = 0; $i < count($_POST['ts']); $i++){		
		...
		if($selectResult->num_rows > 0){
			$updateSql = "UPDATE TS SET sendStatus='0' where suppName='$_POST[supplier]' and tsNo='$tsno' and rev='$rev'";
	...
	src='export2pdf.php?supplier=".$_POST['supplier']."&supppic=".$_POST['pic']."&";
