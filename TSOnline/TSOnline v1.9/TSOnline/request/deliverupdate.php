<?php
	...
	for($i = 0; $i < count($_POST['inputts']); $i++){		
		...
		if($selectResult->num_rows > 0){
			$updateSql = "UPDATE TS SET sendDate='$date', sendStatus='1' where suppName='$_POST[suppname]' and tsNo='$tsno' and rev='$rev'";
			...
			// Insert query to db
			$insertSql = "INSERT INTO ts (tsNo,rev,suppName, reqDate, sendDate, sendStatus, pic) 
						VALUES ('$tsno', '$rev', '$_POST[suppname]', '$date', '$date', '1', '$_SESSION[usernamets]')";
